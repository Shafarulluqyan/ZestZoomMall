...
const AddProduct = () => {
  ...
  const handleImageChange = (event) => {
    const { name, value } = event.target;
    const newImageInputs = { ...formInputs.images, [name]: value };
    setFormInputs((prevInputs) => ({
      ...prevInputs,
      images: newImageInputs,
    }));
  };
    ...
    try {
      const res = await fetch("http://localhost:3000/products", {
        ...
        body: JSON.stringify({
          ...
          colour: formInputs.colour,
          price: formInputs.price,
          description: formInputs.description,
          mainImg: formInputs.mainImg,
          images: {
            imgUrl1: formInputs.images.imgUrl1,
            imgUrl2: formInputs.images.imgUrl2,
            imgUrl3: formInputs.images.imgUrl3,
            imgUrl4: formInputs.images.imgUrl4,
          },
        }),
      });
